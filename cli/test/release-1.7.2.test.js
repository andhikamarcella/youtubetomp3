...
test('1.7.2 parses deterministic upscale targets', () => {
...
test('1.7.2 exposes content and transcript aliases', () => {
...
test('1.7.2 accepts supported Deno and rejects older or malformed versions', () => {
