...
test('1.7.6 parses deterministic upscale targets', () => {
...
test('1.7.6 exposes content and transcript aliases', () => {
...
test('1.7.6 accepts supported Deno and rejects older or malformed versions', () => {
