...
test('1.7.4 parses deterministic upscale targets', () => {
...
test('1.7.4 exposes content and transcript aliases', () => {
...
test('1.7.4 accepts supported Deno and rejects older or malformed versions', () => {
