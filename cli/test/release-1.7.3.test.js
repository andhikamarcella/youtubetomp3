...
test('1.7.3 parses deterministic upscale targets', () => {
...
test('1.7.3 exposes content and transcript aliases', () => {
...
test('1.7.3 accepts supported Deno and rejects older or malformed versions', () => {
