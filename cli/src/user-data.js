...
function completionScript(shell) {
  const commands = 'download playlist batch info formats subtitles extract transcript login logout social doctor repair clean update config profile history completion quickstart docs about shortcuts';
