...
VERSION="1.7.1"
CHANNEL="latest"
RELEASE_BRANCH="release/ytconv-1.7.1"
PRINT_PLAN=0
...
node_supported || fail "Node.js $(node --version) is unsupported. Install Node.js 22.14+ or use a native 1.7.1 package."
...
say "Native DEB, RPM, Arch, Alpine APK, AppImage, Snap, Flatpak, and Nix artifacts are available in the 1.7.1 GitHub release."
