# Checklist rilis YTConv 1.2.0

Dokumen ini adalah checklist final sebelum memublikasikan paket `ytconv@1.2.0` ke npm. Jangan lewati langkah dan jangan menggunakan ulang nomor versi yang sudah pernah terbit.
...
- `package.json` versi `1.2.0`;
- `README.md` berjudul YTConv CLI 1.2.0;
- `CHANGELOG.md` memiliki bagian 1.2.0;
- `ish/VERSION` dan konstanta versi frontend iSH bernilai 1.2.0;
- test rilis mengharapkan 1.2.0;
- PR #145 menyebut rilis final 1.2.0.
...
`1.2.0` tidak boleh sudah ada. npm tidak mengizinkan isi versi yang sudah dipublikasikan untuk ditimpa.

## 9. Login dan verifikasi pemilik paket
...
```bash
npm view ytconv version --prefer-online
npm view ytconv@1.2.0 dist.integrity
```

Versi terbaru wajib menampilkan `1.2.0`.

## 12. Uji paket publik dari instalasi bersih
...
- Jangan mengubah atau mencoba memublikasikan ulang `1.2.0`.
- Perbaikan berikutnya wajib memakai versi baru, misalnya `1.2.1`.
