...
The npm CLI needs Node.js 22.14.0+ and npm 10+. Node 24 LTS is recommended for YTConv 1.7.2. Official downloads are available from [nodejs.org](https://nodejs.org/en/download).
