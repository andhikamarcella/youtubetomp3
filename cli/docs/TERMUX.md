...
Full beginner guide: [Node.js on Termux](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.6.2-cli-only-final/cli/docs/NODEJS.md#android-with-termux).
