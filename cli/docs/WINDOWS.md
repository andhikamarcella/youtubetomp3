...
Follow the [beginner Node.js guide for Windows](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.6.2-cli-only-final/cli/docs/NODEJS.md#windows-10-or-windows-11).
...
- [Node.js guide](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.6.2-cli-only-final/cli/docs/NODEJS.md)
- [Installation guide](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.6.2-cli-only-final/cli/docs/INSTALL.md)
- [Troubleshooting](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.6.2-cli-only-final/cli/docs/TROUBLESHOOTING.md)
