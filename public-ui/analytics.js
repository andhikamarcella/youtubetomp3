(() => {
  ...
  const loadSecondaryRouteUi = () => {
    if (document.querySelector('script[data-ytconv-secondary-route-ui-v13]')) return;
    ...
    routeUi.src = '/secondary-route-ui-v13.js?v=20260714-13';
    routeUi.async = false;
  ...
  const loadVisualFix = () => {
    ...
    fix.src = '/theme-mobile-fix-v9.js?v=20260714-13';
    fix.async = false;
  ...
  const loadResponsivePolish = () => {
    ...
    polish.src = '/responsive-polish-v8.js?v=20260714-13';
    polish.async = false;
  ...
  const loadChatRuntime = () => {
    ...
    runtime.src = '/chat-runtime-v7.js?v=20260714-13';
    runtime.async = false;
  ...
  const loadChatInteraction = () => {
    ...
    interaction.src = '/chat-interaction-v6.js?v=20260714-13';
  ...
  const loadRealisticChat = () => {
    ...
    realism.src = '/chat-realism-v5.js?v=20260714-13';
    realism.async = false;
  ...
  const loadChatLayout = () => {
    ...
    chat.src = '/chat-layout-v4.js?v=20260714-13';
    chat.async = false;
  ...
  if (existingEnhancement) {
    ...
    script.src = '/ui-enhancements.js?v=20260714-13';
    script.async = false;
