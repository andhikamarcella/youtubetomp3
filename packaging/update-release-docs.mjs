...
const newBranch = 'release/ytconv-1.6.5-packages';

function updateFile(file) {
  let text = fs.readFileSync(file, 'utf8').replace(/\r\n/gu, '\n');
  text = text.replaceAll(oldBranch, newBranch);
  text = text.replaceAll('ytconv-v1.6.4', 'ytconv-v1.6.5');
  text = text.replaceAll('ytconv-1.6.4.tgz', 'ytconv-1.6.5.tgz');
  text = text.replaceAll('YTConv 1.6.4', 'YTConv 1.6.5');
  text = text.replaceAll('version 1.6.4', 'version 1.6.5');
