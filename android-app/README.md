...
- `YTConv-1.6.8-debug.apk` — debug-signed and installable for testing
- `YTConv-1.6.8-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.6.8-source.tar.gz` — corresponding source archive
