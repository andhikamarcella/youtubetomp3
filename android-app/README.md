...
- `YTConv-1.7.3-debug.apk` — debug-signed and installable for testing
- `YTConv-1.7.3-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.7.3-source.tar.gz` — corresponding source archive
