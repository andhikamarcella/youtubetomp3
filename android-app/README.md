...
- `YTConv-1.7.5-debug.apk` — debug-signed and installable for testing
- `YTConv-1.7.5-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.7.5-source.tar.gz` — corresponding source archive
