...
- `YTConv-1.7.6-debug.apk` — debug-signed and installable for testing
- `YTConv-1.7.6-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.7.6-source.tar.gz` — corresponding source archive
