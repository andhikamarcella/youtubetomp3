...
- `YTConv-1.6.7-debug.apk` — debug-signed and installable for testing
- `YTConv-1.6.7-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.6.7-source.tar.gz` — corresponding source archive
