...
- `YTConv-1.7.4-debug.apk` — debug-signed and installable for testing
- `YTConv-1.7.4-release-unsigned.apk` — unsigned release build for downstream signing
- `YTConv-Android-1.7.4-source.tar.gz` — corresponding source archive
