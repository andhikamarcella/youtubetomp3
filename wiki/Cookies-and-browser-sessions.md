...
Pilih format Netscape, jangan JSON. Jangan unggah, commit, email, atau tempel cookies. Cookies tidak melewati DRM, paywall, wilayah, atau izin akun. Baca [panduan lengkap branch 1.7.3](https://github.com/andhikamarcella/YTConv/blob/release/ytconv-1.7.3/cli/docs/COOKIES.md).
